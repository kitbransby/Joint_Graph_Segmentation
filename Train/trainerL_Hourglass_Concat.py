...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", type=str, default=datetime.datetime.now().strftime('%m_%d_%H_%M_%S')+'_HOURGLASS_CONCAT')
    ...
    print('Model: Hourglass Concat')
    model = Hourglass_Concat(config, D_t, U_t, A_t)
